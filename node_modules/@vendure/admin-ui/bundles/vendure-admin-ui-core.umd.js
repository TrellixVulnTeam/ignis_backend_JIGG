(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var AdministratorDataService = /** @class */ (function () {
        ...
        AdministratorDataService.prototype.getActiveAdministrator = function () {
    ...
    LocalStorageService.ɵprov = i0__namespace.ɵɵdefineInjectable({ factory: function LocalStorageService_Factory() { return new LocalStorageService(i0__namespace.ɵɵinject(i1__namespace.Location)); }, token: LocalStorageService, providedIn: "root" });
    ...
    var PRODUCT_DETAIL_FRAGMENT = apolloAngular.gql(templateObject_6$6 || (templateObject_6$6 = __makeTemplateObject(["\n    fragment ProductDetail on Product {\n        id\n        createdAt\n        updatedAt\n        enabled\n        languageCode\n        name\n        slug\n        description\n        featuredAsset {\n            ...Asset\n        }\n        assets {\n            ...Asset\n        }\n        translations {\n            id\n            languageCode\n            name\n            slug\n            description\n        }\n        optionGroups {\n            ...ProductOptionGroup\n        }\n        facetValues {\n            id\n            code\n            name\n            facet {\n                id\n                name\n            }\n        }\n        channels {\n            id\n            code\n        }\n    }\n    ", "\n    ", "\n"], ["\n    fragment ProductDetail on Product {\n        id\n        createdAt\n        updatedAt\n        enabled\n        languageCode\n        name\n        slug\n        description\n        featuredAsset {\n            ...Asset\n        }\n        assets {\n            ...Asset\n        }\n        translations {\n            id\n            languageCode\n            name\n            slug\n            description\n        }\n        optionGroups {\n            ...ProductOptionGroup\n        }\n        facetValues {\n            id\n            code\n            name\n            facet {\n                id\n                name\n            }\n        }\n        channels {\n            id\n            code\n        }\n    }\n    ", "\n    ", "\n"])), PRODUCT_OPTION_GROUP_FRAGMENT, ASSET_FRAGMENT);
    ...
    var DELETE_PRODUCT_VARIANT = apolloAngular.gql(templateObject_31 || (templateObject_31 = __makeTemplateObject(["\n    mutation DeleteProductVariant($id: ID!) {\n        deleteProductVariant(id: $id) {\n            result\n            message\n        }\n    }\n"], ["\n    mutation DeleteProductVariant($id: ID!) {\n        deleteProductVariant(id: $id) {\n            result\n            message\n        }\n    }\n"])));
    var GET_PRODUCT_VARIANT_OPTIONS = apolloAngular.gql(templateObject_32 || (templateObject_32 = __makeTemplateObject(["\n    query GetProductVariantOptions($id: ID!) {\n        product(id: $id) {\n            id\n            createdAt\n            updatedAt\n            name\n            optionGroups {\n                ...ProductOptionGroup\n                options {\n                    ...ProductOption\n                }\n            }\n            variants {\n                id\n                createdAt\n                updatedAt\n                enabled\n                name\n                sku\n                price\n                stockOnHand\n                enabled\n                options {\n                    id\n                    createdAt\n                    updatedAt\n                    name\n                    code\n                    groupId\n                }\n            }\n        }\n    }\n    ", "\n    ", "\n"], ["\n    query GetProductVariantOptions($id: ID!) {\n        product(id: $id) {\n            id\n            createdAt\n            updatedAt\n            name\n            optionGroups {\n                ...ProductOptionGroup\n                options {\n                    ...ProductOption\n                }\n            }\n            variants {\n                id\n                createdAt\n                updatedAt\n                enabled\n                name\n                sku\n                price\n                stockOnHand\n                enabled\n                options {\n                    id\n                    createdAt\n                    updatedAt\n                    name\n                    code\n                    groupId\n                }\n            }\n        }\n    }\n    ", "\n    ", "\n"])), PRODUCT_OPTION_GROUP_FRAGMENT, PRODUCT_OPTION_FRAGMENT);
    var ASSIGN_PRODUCTS_TO_CHANNEL = apolloAngular.gql(templateObject_33 || (templateObject_33 = __makeTemplateObject(["\n    mutation AssignProductsToChannel($input: AssignProductsToChannelInput!) {\n        assignProductsToChannel(input: $input) {\n            id\n            channels {\n                id\n                code\n            }\n        }\n    }\n"], ["\n    mutation AssignProductsToChannel($input: AssignProductsToChannelInput!) {\n        assignProductsToChannel(input: $input) {\n            id\n            channels {\n                id\n                code\n            }\n        }\n    }\n"])));
    var ASSIGN_VARIANTS_TO_CHANNEL = apolloAngular.gql(templateObject_34 || (templateObject_34 = __makeTemplateObject(["\n    mutation AssignVariantsToChannel($input: AssignProductVariantsToChannelInput!) {\n        assignProductVariantsToChannel(input: $input) {\n            id\n            channels {\n                id\n                code\n            }\n        }\n    }\n"], ["\n    mutation AssignVariantsToChannel($input: AssignProductVariantsToChannelInput!) {\n        assignProductVariantsToChannel(input: $input) {\n            id\n            channels {\n                id\n                code\n            }\n        }\n    }\n"])));
    var REMOVE_PRODUCTS_FROM_CHANNEL = apolloAngular.gql(templateObject_35 || (templateObject_35 = __makeTemplateObject(["\n    mutation RemoveProductsFromChannel($input: RemoveProductsFromChannelInput!) {\n        removeProductsFromChannel(input: $input) {\n            id\n            channels {\n                id\n                code\n            }\n        }\n    }\n"], ["\n    mutation RemoveProductsFromChannel($input: RemoveProductsFromChannelInput!) {\n        removeProductsFromChannel(input: $input) {\n            id\n            channels {\n                id\n                code\n            }\n        }\n    }\n"])));
    var REMOVE_VARIANTS_FROM_CHANNEL = apolloAngular.gql(templateObject_36 || (templateObject_36 = __makeTemplateObject(["\n    mutation RemoveVariantsFromChannel($input: RemoveProductVariantsFromChannelInput!) {\n        removeProductVariantsFromChannel(input: $input) {\n            id\n            channels {\n                id\n                code\n            }\n        }\n    }\n"], ["\n    mutation RemoveVariantsFromChannel($input: RemoveProductVariantsFromChannelInput!) {\n        removeProductVariantsFromChannel(input: $input) {\n            id\n            channels {\n                id\n                code\n            }\n        }\n    }\n"])));
    var GET_PRODUCT_VARIANT = apolloAngular.gql(templateObject_37 || (templateObject_37 = __makeTemplateObject(["\n    query GetProductVariant($id: ID!) {\n        productVariant(id: $id) {\n            id\n            name\n            sku\n            featuredAsset {\n                id\n                preview\n                focalPoint {\n                    x\n                    y\n                }\n            }\n            product {\n                id\n                featuredAsset {\n                    id\n                    preview\n                    focalPoint {\n                        x\n                        y\n                    }\n                }\n            }\n        }\n    }\n"], ["\n    query GetProductVariant($id: ID!) {\n        productVariant(id: $id) {\n            id\n            name\n            sku\n            featuredAsset {\n                id\n                preview\n                focalPoint {\n                    x\n                    y\n                }\n            }\n            product {\n                id\n                featuredAsset {\n                    id\n                    preview\n                    focalPoint {\n                        x\n                        y\n                    }\n                }\n            }\n        }\n    }\n"])));
    var GET_PRODUCT_VARIANT_LIST_SIMPLE = apolloAngular.gql(templateObject_38 || (templateObject_38 = __makeTemplateObject(["\n    query GetProductVariantListSimple($options: ProductVariantListOptions!, $productId: ID) {\n        productVariants(options: $options, productId: $productId) {\n            items {\n                id\n                name\n                sku\n                featuredAsset {\n                    id\n                    preview\n                    focalPoint {\n                        x\n                        y\n                    }\n                }\n                product {\n                    id\n                    featuredAsset {\n                        id\n                        preview\n                        focalPoint {\n                            x\n                            y\n                        }\n                    }\n                }\n            }\n            totalItems\n        }\n    }\n"], ["\n    query GetProductVariantListSimple($options: ProductVariantListOptions!, $productId: ID) {\n        productVariants(options: $options, productId: $productId) {\n            items {\n                id\n                name\n                sku\n                featuredAsset {\n                    id\n                    preview\n                    focalPoint {\n                        x\n                        y\n                    }\n                }\n                product {\n                    id\n                    featuredAsset {\n                        id\n                        preview\n                        focalPoint {\n                            x\n                            y\n                        }\n                    }\n                }\n            }\n            totalItems\n        }\n    }\n"])));
    var GET_PRODUCT_VARIANT_LIST = apolloAngular.gql(templateObject_39 || (templateObject_39 = __makeTemplateObject(["\n    query GetProductVariantList($options: ProductVariantListOptions!, $productId: ID) {\n        productVariants(options: $options, productId: $productId) {\n            items {\n                ...ProductVariant\n            }\n            totalItems\n        }\n    }\n    ", "\n"], ["\n    query GetProductVariantList($options: ProductVariantListOptions!, $productId: ID) {\n        productVariants(options: $options, productId: $productId) {\n            items {\n                ...ProductVariant\n            }\n            totalItems\n        }\n    }\n    ", "\n"])), PRODUCT_VARIANT_FRAGMENT);
    var GET_TAG_LIST = apolloAngular.gql(templateObject_40 || (templateObject_40 = __makeTemplateObject(["\n    query GetTagList($options: TagListOptions) {\n        tags(options: $options) {\n            items {\n                ...Tag\n            }\n            totalItems\n        }\n    }\n    ", "\n"], ["\n    query GetTagList($options: TagListOptions) {\n        tags(options: $options) {\n            items {\n                ...Tag\n            }\n            totalItems\n        }\n    }\n    ", "\n"])), TAG_FRAGMENT);
    var GET_TAG = apolloAngular.gql(templateObject_41 || (templateObject_41 = __makeTemplateObject(["\n    query GetTag($id: ID!) {\n        tag(id: $id) {\n            ...Tag\n        }\n    }\n    ", "\n"], ["\n    query GetTag($id: ID!) {\n        tag(id: $id) {\n            ...Tag\n        }\n    }\n    ", "\n"])), TAG_FRAGMENT);
    ...
    var ProductDataService = /** @class */ (function () {
        ...
        ProductDataService.prototype.getPendingSearchIndexUpdates = function () {
            return this.baseDataService.query(GET_PENDING_SEARCH_INDEX_UPDATES);
        };
        ProductDataService.prototype.runPendingSearchIndexUpdates = function () {
        ...
        ProductDataService.prototype.getProduct = function (id, variantListOptions) {
            return this.baseDataService.query(GET_PRODUCT_WITH_VARIANTS, {
                id: id,
                variantListOptions: variantListOptions,
            });
        };
        ...
        ProductDataService.prototype.getProductVariantsSimple = function (options, productId) {
            return this.baseDataService.query(GET_PRODUCT_VARIANT_LIST_SIMPLE, { options: options, productId: productId });
        };
        ProductDataService.prototype.getProductVariants = function (options, productId) {
            return this.baseDataService.query(GET_PRODUCT_VARIANT_LIST, { options: options, productId: productId });
        };
        ...
        ProductDataService.prototype.updateProductOptionGroup = function (input) {
    ...
    AuthService.ɵprov = i0__namespace.ɵɵdefineInjectable({ factory: function AuthService_Factory() { return new AuthService(i0__namespace.ɵɵinject(LocalStorageService), i0__namespace.ɵɵinject(DataService), i0__namespace.ɵɵinject(ServerConfigService)); }, token: AuthService, providedIn: "root" });
    ...
    var I18nService = /** @class */ (function () {
        ...
        Object.defineProperty(I18nService.prototype, "availableLanguages", {
            get: function () {
                return __spreadArray([], __read(this._availableLanguages));
            },
            enumerable: false,
            configurable: true
        });
    ...
    OverlayHostService.ɵprov = i0__namespace.ɵɵdefineInjectable({ factory: function OverlayHostService_Factory() { return new OverlayHostService(); }, token: OverlayHostService, providedIn: "root" });
    ...
    ModalService.ɵprov = i0__namespace.ɵɵdefineInjectable({ factory: function ModalService_Factory() { return new ModalService(i0__namespace.ɵɵinject(i0__namespace.ComponentFactoryResolver), i0__namespace.ɵɵinject(OverlayHostService)); }, token: ModalService, providedIn: "root" });
    ...
    HealthCheckService.ɵprov = i0__namespace.ɵɵdefineInjectable({ factory: function HealthCheckService_Factory() { return new HealthCheckService(i0__namespace.ɵɵinject(i1__namespace$2.HttpClient)); }, token: HealthCheckService, providedIn: "root" });
    ...
    JobQueueService.ɵprov = i0__namespace.ɵɵdefineInjectable({ factory: function JobQueueService_Factory() { return new JobQueueService(i0__namespace.ɵɵinject(DataService)); }, token: JobQueueService, providedIn: "root" });
    ...
    NavBuilderService.ɵprov = i0__namespace.ɵɵdefineInjectable({ factory: function NavBuilderService_Factory() { return new NavBuilderService(); }, token: NavBuilderService, providedIn: "root" });
    ...
    NotificationService.ɵprov = i0__namespace.ɵɵdefineInjectable({ factory: function NotificationService_Factory() { return new NotificationService(i0__namespace.ɵɵinject(I18nService), i0__namespace.ɵɵinject(i0__namespace.ComponentFactoryResolver), i0__namespace.ɵɵinject(OverlayHostService)); }, token: NotificationService, providedIn: "root" });
    ...
    InjectableTranslateMessageFormatCompiler.ɵprov = i0__namespace.ɵɵdefineInjectable({ factory: function InjectableTranslateMessageFormatCompiler_Factory() { return new InjectableTranslateMessageFormatCompiler(i0__namespace.ɵɵinject(i1__namespace$3.MESSAGE_FORMAT_CONFIG, 8)); }, token: InjectableTranslateMessageFormatCompiler, providedIn: "root" });
    ...
    ComponentRegistryService.ɵprov = i0__namespace.ɵɵdefineInjectable({ factory: function ComponentRegistryService_Factory() { return new ComponentRegistryService(); }, token: ComponentRegistryService, providedIn: "root" });
        ...
        AssetPickerDialogComponent.prototype.createAssets = function (files) {
            ...
            if (files.length) {
                ...
                this.dataService.product
                    ...
                    var assets = res.createAssets.filter(function (a) { return a.__typename === 'Asset'; });
                    _this.assetGalleryComponent.selectMultiple(assets);
                });
            }
        };
    ...
    var AssetSearchInputComponent = /** @class */ (function () {
        ...
        AssetSearchInputComponent.prototype.setTags = function (tags) {
            ...
            tags.map(function (tag) {
                return items === null || items === void 0 ? void 0 : items.find(function (item) { return _this.isTag(item) && item.id === tag.id; });
            })
                .filter(sharedUtils.notNullOrUndefined)
    ...
    var IfDirectiveBase = /** @class */ (function () {
        ...
        IfDirectiveBase.prototype.ngOnInit = function () {
            ...
            this.subscription = this.updateArgs$
                .pipe(operators.switchMap(function (args) { return _this.updateViewFn.apply(_this, __spreadArray([], __read(args))); }))
                .subscribe(function (result) {
                if (result) {
                    _this.showThen();
                }
    ...
    SharedModule.decorators = [
        { type: i0.NgModule, args: [{
                    imports: [IMPORTS],
                    exports: __spreadArray(__spreadArray(__spreadArray([], __read(IMPORTS)), __read(DECLARATIONS)), __read(DYNAMIC_FORM_INPUTS)),
                    declarations: __spreadArray(__spreadArray([], __read(DECLARATIONS)), __read(DYNAMIC_FORM_INPUTS)),
                    providers: [
    ...
    function getLocales() {
        ...
        return {
            locales: __spreadArray([defaultLanguage], __read(localesWithoutDefault)),
        };
    }
    ...
    var DashboardWidgetService = /** @class */ (function () {
        ...
        DashboardWidgetService.prototype.getAvailableIds = function (currentUserPermissions) {
            ...
            return __spreadArray([], __read(this.registry.entries())).filter(function (_b) {
        ...
        DashboardWidgetService.prototype.idNotFound = function (id) {
            // tslint:disable-next-line:no-console
            console.error("No dashboard widget was found with the id \"" + id + "\"\nAvailable ids: " + __spreadArray([], __read(this.registry.keys())).map(function (_id) { return "\"" + _id + "\""; })
                .join(', '));
            return;
        };
        DashboardWidgetService.prototype.getValidWidth = function (id, config, targetWidth) {
            ...
            var supportedWidths = ((_a = config.supportedWidths) === null || _a === void 0 ? void 0 : _a.length)
    ...
    DashboardWidgetService.ɵprov = i0__namespace.ɵɵdefineInjectable({ factory: function DashboardWidgetService_Factory() { return new DashboardWidgetService(); }, token: DashboardWidgetService, providedIn: "root" });
    ...
    AuthGuard.ɵprov = i0__namespace.ɵɵdefineInjectable({ factory: function AuthGuard_Factory() { return new AuthGuard(i0__namespace.ɵɵinject(i1__namespace$4.Router), i0__namespace.ɵɵinject(AuthService)); }, token: AuthGuard, providedIn: "root" });
    ...
    function unicodePatternValidator(patternRe) {
        var unicodeRe = patternRe.unicode ? patternRe : new RegExp(patternRe, 'u');
        return function (control) {
            var valid = unicodeRe.test(control.value);
    ...
    exports.GET_PENDING_SEARCH_INDEX_UPDATES = GET_PENDING_SEARCH_INDEX_UPDATES;
    ...
    exports.GET_PRODUCT_VARIANT_LIST_SIMPLE = GET_PRODUCT_VARIANT_LIST_SIMPLE;
    ...
    exports.UPDATE_PRODUCT_OPTION_GROUP = UPDATE_PRODUCT_OPTION_GROUP;
