...
export declare class ProductMultiSelectorDialogComponent implements OnInit, Dialog<SearchItem[]> {
    ...
    select(): void;
    cancel(): void;
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<ProductMultiSelectorDialogComponent, never>;
    static ɵcmp: ɵngcc0.ɵɵComponentDeclaration<ProductMultiSelectorDialogComponent, "vdr-product-multi-selector-dialog", never, {}, {}, never, never>;
}

//# sourceMappingURL=product-multi-selector-dialog.component.d.ts.map