...
export declare class ConfigurableInputComponent implements OnInit, OnChanges, OnDestroy, ControlValueAccessor, Validator {
    ...
    static ɵcmp: ɵngcc0.ɵɵComponentDeclaration<ConfigurableInputComponent, "vdr-configurable-input", never, { "readonly": "readonly"; "removable": "removable"; "position": "position"; "operation": "operation"; "operationDefinition": "operationDefinition"; }, { "remove": "remove"; }, never, never>;
}
